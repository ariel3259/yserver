...
### Task 8: Dual-GPU PRIME Render Offload Validation

- [x] **Step 1: Validate hybrid architecture: `yserver` on AMDGPU KMS + CS2 3D rendering on discrete NVIDIA RTX 5060 Ti**
- [x] **Step 2: Verify unconstrained framerates and memory allocation via `nvidia-smi` without NVIDIA DRM KMS ioctl contention**
- [x] **Step 3: Document findings in design spec**
