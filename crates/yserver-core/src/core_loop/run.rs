...
pub fn run_core(
    ...
    loop {
        ...
        // the next one.
        // Running AFTER run_iteration_tail guarantees that present
        // completions (CompleteNotify, IdleNotify) and damage flushes
        // generated by the tail drain directly to the client socket
        // before the poller blocks.
